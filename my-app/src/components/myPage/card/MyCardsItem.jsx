...
export const myCardItems = [
    ...
    { id: 3, title: "선형대수의 기초", progress: "1/23", thumbnail: "썸네일" },
    { id: 4, title: "데이터 구조와 알고리즘", progress: "10/50", thumbnail: "썸네일" },
    { id: 5, title: "머신러닝 개론", progress: "2/40", thumbnail: "썸네일" },
    { id: 6, title: "AI를 활용한 비즈니스 전략", progress: "5/30", thumbnail: "썸네일" },
