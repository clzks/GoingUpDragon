...
const FindIdInput = ({ isSignUp = false }) => {
  ...
  return (
    <StyledContentWrapper isSignUp = {isSignUp}>
      <div>
        {isSignUp ? (
          <StyledInputLabel>휴대폰 인증</StyledInputLabel>
        ) : (
      ...
      {verificationRequested && (
        <StyledVerificationInputWrapper>
          ...
          />
          <StyledVerifyButton onClick={handleVerify}>인증</StyledVerifyButton>
        </StyledVerificationInputWrapper>
      )}
...
const StyledContentWrapper = styled.div`
  //margin-left: 150px;
  margin-left: ${(props) => (props.isSignUp === true ? "0px" : "150px")};
  display: flex;
...
const StyledPhoneNumberInput = styled.input`
  width: ${(props) => (props.isSignUp === true ? "500px" : "350px")};
  padding: 10px;
  font-size: 1em;
